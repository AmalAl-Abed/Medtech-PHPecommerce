	...
	<div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="dl">
            ...
            <div class="descr">
                <strong>Get 30 percent off when you buy over 100JD</strong> 
            </div>
            <div class="ends">
        ...
        <div class="col-sm-6 col-md-3">
          <div  class="dl">
            ...
            <div class="descr">
                <strong>
                Get 15 percent off when you buy over 50JD. 
                </strong> 
            </div>
            <div class="ends">
                <small>
        ...
        <div class="col-sm-6 col-md-3">
          <div  class="dl">
            ...
            <div class="descr">
                <strong>
                Get 50 percent off when you buy over 300JD. 
                </strong> 
            </div>
            <div class="ends">
                <small>
        ...
        <div class="col-sm-6 col-md-3">
          <div  class="dl">
            ...
            <div class="descr">
                <strong>
                Get 25 percent off when you buy over 75JD. 
                </strong> 
            </div>
            <div class="ends">
                <small>
